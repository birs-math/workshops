...
RUN echo 'export PATH=$PATH:./bin:/usr/local/rvm/rubies/ruby-2.7.8/bin'>> /root/.bashrc
RUN echo 'alias rspec="bundle exec rspec"' >> /root/.bashrc

# Install Ruby 2.7.8 on the proven 2.4.1 base (minimal change vs swapping the whole base image)
